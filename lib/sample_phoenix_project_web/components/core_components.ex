defmodule SamplePhoenixProjectWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SamplePhoenixProjectWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SamplePhoenixProjectWeb.Gettext, "errors", msg, opts)
    end
  end
